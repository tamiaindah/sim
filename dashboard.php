...
<body>
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <li class="nav-item">
                <a class="nav-link" href="modul/profil/profil.php">Profil</a>
            </li>
            <li class="nav-item dropdown">
                ...
                <a class="dropdown-item" href="modul/kategori/kategori.php">Kategori Wisata</a>
                <a class="dropdown-item" href="modul/wisata/wisata.php">Wisata</a>
        ...
        <div class="jumbotron mt-4">
            <h1 class="display-4">Hello, <?php echo $_SESSION['namaadmin'] ?></h1>
