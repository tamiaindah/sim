...
<body>
    <div class="container">
        ...
        <br/>
        <a class="btn btn-primary" href="tambah_berita.php" role="button">[+] Tambah Berita</a>
        ...
        <table class="table mt-4">
            ...
            <tbody>
                ...
                <td><?php echo $r['user_berita'] ?></td>
                <td><?php echo $tgl_baru ?></td>
                <td><img src="../../img_berita/<?php echo $r['foto_berita'] ?>" height="50" width="50"></td>
                <td>
                <a class="btn btn-success" href="edit_berita.php?id=<?php echo $r['id_berita'] ?>" role="button">EDIT</a>
                <a class="btn btn-danger" href="hapus_berita.php?id=<?php echo $r['id_berita'] ?>" role="btton">HAPUS</a>
                </td>
                </tr>
                <?php } ?>
            </tbody>
