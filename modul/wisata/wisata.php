...
<body>
    <div class="container">
        ...
        <br/>
        <a class="btn btn-primary" type="submit" href="tambah_wisata.php" > [+] Tambah Wisata</a>
        ...
        <table class="table mt-4">
            ...
            <tbody>
                <?php
                    ...
                    $sql = mysqli_query($koneksi, "SELECT * FROM tb_wisata, tb_kategori
                    where tb_wisata.kategori_wisata=tb_kategori.id_kategori");
                ...
                <td><img src="../../img_wisata/<?php echo $r['foto_wisata'] ?>" height="50" width="50"></td>
                <td>
                    <a class="btn btn-success" href="edit_wisata.php?id=<?php echo $r['id_wisata']?>" role="button">EDIT</a>
                    <a class="btn btn-danger" href="hapus_wisata.php?id=<?php echo $r['id_wisata']?>" role="button">HAPUS</a> </td>
                </tr>
                <?php } ?>
            </tbody>
        </table>
