...
<body>
    <div class="container">
        ...
        <div class="form-group">
                <label for="exampleInputEmail">Id Kategori</label>
                <input type="text" class="form-control" name="id_kategori" placeholder="Contoh: Id Kategori">
            </div>
            <div class="form-group">
                <label for="exampleInputEmail">Nama Kategori</label>
                <input type="text" class="form-control" name="nama_kategori" placeholder="Contoh: Wisata Ayam">
            </div>
        ...
        <?php
            ...
            if (isset($_POST['submit'])) {
                ...
                mysqli_query($koneksi, "insert into tb_kategori values ('$id_kategori','$nama_kategori')");
